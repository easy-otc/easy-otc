...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="650" style="border-collapse: collapse;">
    <tr>
        <td align="left" bgcolor="#78ab46" style="padding: 40px 0 30px 30px;">
            <p>Dear,</p>
            <p>we are very happy to inform you that your xxxx account, private key and public key have already been
                generated. Please refer to the below information and keep them in a security way.</p>
        </td>
    </tr>
    <tr>
